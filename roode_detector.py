...
CLIP embedding이 Roode signal direction으로 편향됐는지 통계 검정한다.
...
class RoodeDetector:
    ...
    def _interpret(self, p_value, effect_size):
        ...
        if p_value < 0.001 and effect_size > 0.8:
            ...
            return "MODERATE EVIDENCE: Likely Roode signal present"
        elif p_value < 0.05:
            return "WEAK EVIDENCE: Possible Roode signal — further testing recommended"
        else:
    ...
    def generate_report(self, results, model_name, commitment_hash=None):
        ...
        report = f"""
╔══════════════════════════════════════════════════════════════════╗
║          Roode Detection Report  /  탐지 리포트                  ║
╚══════════════════════════════════════════════════════════════════╝

대상 모델    : {model_name}
분석 일시    : {ts}
탐지 방법    : Black-box probe + CLIP embedding statistical test
프로토콜     : Roode Detection Protocol v1.0
...
⚖️  법적 함의 (Legal Implications)
   ...
   1. Roode 플랫폼은 DMCA §1201 기준 기술적 보호조치(TPM)를 적용함
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   ...
   이 리포트는 Roode Detection Protocol v1.0에 따라 자동 생성됨.
